...
После выбора клиента появляются два дополнительных поля, как показано на изображении:

<figure><img src="../../../.gitbook/assets/image (39).png" alt=""><figcaption></figcaption></figure>

**Первое поле:** выбор бронирования из списка, к которому необходимо привязать инвойс. Данное поле не обязательно для заполнения. После выбора бронирования из списка поля начала и окончания инвойса заполняются автоматически (их также можно изменить вручную).

<figure><img src="../../../.gitbook/assets/image (8) (1).png" alt=""><figcaption></figcaption></figure>

**Второе поле:** список процедурных листов, оформленных на клиента. В этом поле можно выбрать один или несколько процедурных листов и, нажав на кнопку "Добавить процедуры", добавить все процедуры из этих процедурных листов в инвойс. Данное поле не обязательно для заполнения. Пример заполненного поля на изображении:

<figure><img src="../../../.gitbook/assets/image (40).png" alt=""><figcaption></figcaption></figure>

**Примечания:**

* Данное поле работает только на добавление процедур в инвойс. Отмена выбора чекбокса после добавления процедур в инвойс никак не влияет на список процедур в инвойсе.
* Процедуры добавляются в инвойс только после нажатия на кнопку "Добавить процедуры".
* При добавлении процедур из нескольких процедурных листов, а также при повторном добавлении процедур из процедурных листов, общее количество повторяющихся процедур суммируется.
* Чтобы отслеживать дублирующиеся процедуры было проще, количество процедур отображается в двух значениях: количество уникальных процедур и рядом в скобках показано общее количество процедур. Например: если Процедуру А добавили в Процедурный лист дважды, а Процедуру Б добавили один раз, то количество уникальных процедур будет 2 штуки, а общее количество будет 3 штуки.
* Чтобы не перепутать, какое количество процедур уже есть в инвойсе, какое количество процедур в выбранных процедурных листах и сколько процедур будет в инвойсе после добавления процедур из процедурных листов, в поле добавлены соответствующие примечания.
