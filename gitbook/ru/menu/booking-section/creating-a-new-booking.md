...
4 — **Статус клиента в заказе**: клиент является пациентом, которому будут предоставлены услуги, или является сопровождающим лицом, которому не будут оказываться услуги, и которому требуется только комната для проживания.
